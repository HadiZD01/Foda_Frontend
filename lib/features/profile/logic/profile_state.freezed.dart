...
/// @nodoc
abstract mixin class $SuccessCopyWith<T,$Res> implements $ProfileStateCopyWith<T, $Res> {
...
@override
String toString() {
  return 'ProfileState<$T>.failure(apiErrorModel: $apiErrorModel)';
}
...
/// @nodoc
abstract mixin class $ErrorCopyWith<T,$Res> implements $ProfileStateCopyWith<T, $Res> {
